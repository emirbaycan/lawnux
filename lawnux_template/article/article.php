...
$m = $sql->get($mysqli, 'SELECT a.*,b.nick,b.image user_image,c.instagram,c.youtube,c.linkedin FROM articles a left join user_infos b on a.user= b.user_id left join writers c on a.user = c.id WHERE a.page=?', [$page]);
...
$created_at = explode('-', explode(' ', $data['created_at'])[0]);
...
<head>
    ...
    <title><?php echo $header; ?> - Lawnux</title>
...
<body class="preload">
    ...
    <div class="articles-right widther">
        <div class="writer">
            <div class="writer-inner">
                <div class="writer-img-holder">
                    <div class="writer-img" style="background-image:url(<?php echo $user_image; ?>)"></div>
                </div>
        ...
        <div class="articles-bot">
            <div class="article-top">
                <h2 class="article-header"><?php echo $header; ?></h2>
                <p class="article-date">
                    <span class="icon-date"></span>
                    <label class="article-date-text"><?php echo $created_at ?></label>
                </p>
            </div>
            <div class="articles-bot-inner">
                ...
                <div class="share-outer">
                    <div class="shares">
                        ...
                        <div class="share-bot">
                            <button class="share icon-twitter" id="twitter"></button>
                            <button class="share icon-linkedin" id="linkedin"></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="../js/main/article.js" defer></script>
    <footer>
